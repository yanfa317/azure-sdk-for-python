...
class ProductsOperations(object):
    ...
    def update_auto_renew_by_billing_account(
        ...
        # Construct URL
        url = self.update_auto_renew_by_billing_account.metadata['url']
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
            'productName': self._serialize.url("product_name", product_name, 'str')
        }
        ...
        return deserialized
    update_auto_renew_by_billing_account.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/products/{productName}/updateAutoRenew'}
